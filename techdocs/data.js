export default [
  ...
  {
    headline: 'What you should already know',
...
<p>
  ...
  },
  {
    headline: 'Constants',
    article: `<p>
  You can create a read-only, named constant with the const keyword. The syntax
  of a constant identifier is the same as for a variable identifier: it must
  start with a letter, underscore or dollar sign and can contain alphabetic,
...
<code
  >// THIS WILL CAUSE AN ERROR function f() {}; const f = 5; // THIS WILL CAUSE
  AN ERROR ALSO function f() { const g = 5; var g; //statements }</code
>
<p>
...
<code> const MY_OBJECT = {"key": "value"}; MY_OBJECT.key = "otherValue";</code>`,
  ...
  {
    headline: 'Data types',
    article: `<p>The latest ECMAScript standard defines seven data types:</p>
<ul>
  <li>
    ...
    <ul>
      ...
      <li>String. "Howdy"</li>
      <li>
        Symbol (new in ECMAScript 2015). A data type whose instances are unique
        and immutable.
      </li>
    </ul>
  </li>
...
<p>
  ...
  for an explanation of what evaluates to true and false. If condition evaluates
  to true, statement_1 is executed; otherwise, statement_2 is executed.
  statement_1 and statement_2 can be any statement, including further nested if
  statements.
</p>
<p>
...
<code
  >if (condition_1) { statement_1; } else if (condition_2) { statement_2; } else
  if (condition_n) { statement_n; } else { statement_last; }</code
>
<p>
...
<code>if ((x = y)) { /* statements here */ }</code>`,
  ...
  {
    headline: 'while statement',
    article: `<p>
  A while statement executes its statements as long as a specified condition
  evaluates to true. A while statement looks as follows:
</p>
<code> codewhile (condition) statement </code>
<p>
...
<p>
  ...
  again. If the condition returns false, execution stops and control is passed
...
<p>After completing the third pass, the condition n < 3 is no longer true, so the loop terminates.</p>`,
  ...
  {
    headline: 'Function declarations',
    article: `<p>
...
<p>
  ...
  of one statement that says to return the argument of the function (that is,
  number) multiplied by itself. The return statement specifies the value
...
<p>Primitive parameters (such as a number) are passed to functions by value; the value is passed to the function, but if the function changes the value of the parameter, this change is not reflected globally or in the calling function.</p>`,
  ...
  {
    headline: 'Reference',
    article: `<p>All the documentation in this page is taken from <a href="https://developer.mozilla.org/en-US/docs/Web/JavaScript/Guide">MDN</a></p>`,
  },
];
